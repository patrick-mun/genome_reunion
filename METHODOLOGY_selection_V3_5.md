...
**Version : V3.5 géo-ancestrale — panels témoins EGA + 1000G**  
...
Cette version précise également l’intégration opérationnelle des panels témoins **1000 Genomes / IGSR** et **EGA**. Ces panels ne remplacent pas la cohorte réunionnaise : ils servent à ancrer les axes PCA, stabiliser l’interprétation des composantes ADMIXTURE, tester la robustesse de la stratification géo-ancestrale et soutenir les analyses d’imputation ou de LAI lorsque leur qualité le permet.
...
Cette approche vise à intégrer une variable biologique pertinente pour la médecine génomique : l’ascendance génétique inférée, mesurée à partir de données SNP, de pools témoins, de PCA, d’ADMIXTURE et, si nécessaire, de LAI. Les pools témoins seront organisés selon une hiérarchie opérationnelle : socle public 1000 Genomes / IGSR, panels prioritaires EGA pour Madagascar, l’Asie et l’Afrique de l’océan Indien, puis panels complémentaires africains et austronésiens.
...
Point de garde-fou : les pools témoins ne servent pas à assigner une identité aux individus réunionnais. Ils servent à construire un espace génétique interprétable, à stabiliser les labels ADMIXTURE, à repérer les profils sous-représentés et à tester la robustesse de la stratification géo-ancestrale. Les fréquences finales réunionnaises ne seront jamais déduites des panels témoins : elles seront recalibrées sur la cohorte SNP réunionnaise et, lorsque possible, sur l’imputation issue du panel WGS local.

Pools témoins recommandés, sous réserve de disponibilité, d’accès et de qualité :

| Dimension recherchée | Type de référence possible | Usage attendu |
|---|---|---|
| Afrique subsaharienne / Afrique de l’Est / Afrique australe | 1000G, AGVP, H3Africa, Angola/Mozambique | ancrage des composantes africaines et bantoues |
| Europe | 1000G CEU/TSI/IBS/GBR ou équivalents | ancrage européen |
| Inde / Asie du Sud | 1000G GIH/ITU/PJL/BEB/STU, GenomeAsia | ancrage sud-asiatique, pertinent pour l’histoire réunionnaise |
| Madagascar / océan Indien | MGUA WGS, MAGE Madagascar SNP | dimension critique pour l’axe malgache et indo-océanique |
| Asie de l’Est / Chine | 1000G CHB/CHS/JPT/KHV, GenomeAsia | ancrage est-asiatique |
| Sud-Est asiatique / axe austronésien | GenomeAsia, Pacific WGS | analyse exploratoire et prudente de l’axe austronésien |
...
### 6.3 Catalogue opérationnel des panels témoins EGA + 1000G

Les panels témoins seront organisés en trois niveaux. Cette hiérarchie évite de mélanger sans contrôle des ressources de nature différente : WGS haute couverture, WGS faible ou moyenne couverture, génotypages SNP, panels publics et datasets en accès contrôlé.

| Niveau | Panel témoin | Accession / source | Type de données | Rôle principal | Limites à documenter |
|---|---|---|---|---|---|
| **0 — Socle public immédiat** | 1000 Genomes high-coverage / IGSR | ressource publique 1000G / IGSR | WGS haute couverture, 26 populations, trios | socle multi-ancestral public pour PCA, ADMIXTURE, phasage et imputation | faible couverture directe de Madagascar et de l’océan Indien |
| **1 — Prioritaire EGA** | MGUA Malagasy WGS | `EGAS50000000496` / `EGAD50000000708` | WGS mid-pass, 264 individus malgaches | ancrage malgache direct, critique pour La Réunion | accès contrôlé, trois régions malgaches seulement, couverture mid-pass |
| **1 — Prioritaire EGA** | MAGE Madagascar | `EGAS00001002549` / `EGAD00010001612` | génotypage SNP Omni 2.5M, 737 individus | structure géographique interne de Madagascar | pas un WGS ; utilité principale pour PCA/ADMIXTURE, pas pour imputation WGS |
| **1 — Prioritaire EGA** | GenomeAsia 100K | `EGAS00001002921` / `EGAD00001005975` | WGS / VCF asiatiques | ancrage sud-asiatique, est-asiatique et sud-est asiatique | accès contrôlé, forte hétérogénéité interne, harmonisation nécessaire |
| **1 — Prioritaire EGA** | Angola / Mozambique WGS | `EGAS00001007458` / `EGAD00001011992` | WGS, CRAM alignés GRCh37/hg19 | ancrage bantou, Afrique australe-orientale, trajectoires océan Indien | pas un substitut à toute l’Afrique ; harmonisation build nécessaire |
| **2 — Complémentaire EGA** | AGVP | `EGAS00001000960` / `EGAD00001001663` | WGS faible couverture + génotypages denses africains | diversité africaine large, contrôle de robustesse | couverture hétérogène, faible couverture pour certains WGS |
| **2 — Complémentaire EGA** | H3Africa WGS | `EGAS00001005972` / `EGAD00001008577` | joint VCF WGS africain | complément africain large pour PCA/ADMIXTURE/LAI | accès contrôlé, composition hétérogène, metadata variables |
| **2 — Exploratoire EGA** | Pacific WGS | `EGAS00001004540` / `EGAD00001006880` | WGS haute couverture Pacifique | complément austronésien exploratoire | ne remplace pas Madagascar ; interprétation prudente |

Un panel témoin sera retenu dans l’analyse finale seulement s’il satisfait plusieurs critères :

- accès obtenu ou ressource publique disponible ;
- build génomique documenté et harmonisable avec la cohorte Réunion ;
- intersection suffisante avec la puce SNP 1,9 M après QC ;
- contrôle des SNP ambigus et des problèmes de strand ;
- absence de batch effect majeur dans la PCA ;
- stabilité des composantes ADMIXTURE sur plusieurs seeds ;
- cohérence avec les connaissances historiques et avec la PCA projetée ;
- documentation explicite des limites et des panels exclus.

Les analyses seront conduites par niveaux afin de mesurer l’impact de l’ajout des panels témoins :

```text
Niveau A : Réunion seule
Niveau B : Réunion + 1000G high-coverage
Niveau C : Réunion + 1000G + panels EGA prioritaires
Niveau D : Réunion + 1000G + EGA prioritaires + EGA complémentaires
```

Cette logique permet d’évaluer si un panel témoin améliore réellement l’ancrage des composantes ou s’il introduit au contraire du bruit, un batch effect ou une instabilité d’interprétation.

### 6.4 PCA de référence et projection des individus réunionnais

La PCA sera utilisée selon plusieurs niveaux complémentaires afin de distinguer la structure interne de La Réunion de l’ancrage par références externes :

1. **PCA-0 — Réunion seule** : PCA interne sur les 2500 individus, pour analyser la structure propre de la cohorte réunionnaise.
2. **PCA-1 — Réunion + 1000G** : ancrage public multi-ancestral, utilisable immédiatement.
3. **PCA-2 — Réunion + 1000G + panels EGA prioritaires** : ajout de MGUA, MAGE Madagascar, GenomeAsia et Angola/Mozambique si l’accès et le QC le permettent.
4. **PCA-3 — Analyse de sensibilité** : comparaison avec et sans panels complémentaires AGVP, H3Africa et Pacific WGS.
...
QC commun + LD pruning + harmonisation build/strand
        ↓
PCA par niveaux : PCA-0, PCA-1, PCA-2, PCA-3
        ↓
projection ou positionnement des individus réunionnais
        ↓
comparaison de stabilité des axes et des clusters géo-ancestraux
```
...
Un panel témoin qui déforme fortement l’espace PCA, introduit un effet de lot ou réduit trop fortement l’intersection SNP ne doit pas être retenu automatiquement. Son effet devra être documenté dans un rapport de sensibilité.

### 6.5 ADMIXTURE : non supervisé, supervisé et interprétation de K
...
|---|---|---|
| **ADMIXTURE-0** : non supervisé sur les 2500 | découvrir la structure interne réunionnaise | utile mais labels non garantis |
| **ADMIXTURE-1** : 2500 + 1000G | ancrer les composantes sur un socle public multi-ancestral | attribution plus interprétable mais encore incomplète pour Madagascar |
| **ADMIXTURE-2** : 2500 + 1000G + EGA prioritaires | tester l’apport de MGUA, MAGE, GenomeAsia et Angola/Mozambique | meilleure résolution potentielle des axes malgache, sud-asiatique, est-asiatique et bantou/océan Indien |
| **ADMIXTURE-3** : supervisé ou semi-supervisé | estimer les proportions par rapport à des références retenues après QC | utile pour les clusters géo-ancestraux, à condition de ne pas surinterpréter les labels |
| Analyse multi-K et multi-seed | tester la robustesse | éviter de figer artificiellement K |
...
### 6.6 Construction des profils d’ascendance génétique inférée
...
Les clusters retenus devront être comparés entre les niveaux d’analyse (`Réunion seule`, `Réunion + 1000G`, `Réunion + 1000G + EGA prioritaires`). Un cluster qui apparaît uniquement après l’ajout d’un panel témoin devra être interprété avec prudence et validé par cohérence avec la PCA, ADMIXTURE, l’IBD/ROH, la géographie et la littérature.
...
### 6.7 Construction des cellules géo-ancestrales
...
### 6.8 Attribution des quotas WGS
...
### 6.9 Biais potentiel de recrutement EFS
...
### 6.10 Validation comparative de la contrainte géo-ancestrale
...
### 13.2 Groupes de validation et panels externes

La validation sera conduite par couches, afin de distinguer ce qui relève de la robustesse générale de l’algorithme et ce qui dépend de la disponibilité des panels témoins EGA.

| Couche | Données | Objectif |
|---|---|---|
| **Validation A — 1000G public** | ACB/ASW, GIH/BEB, CEU/IBS/TSI, CHB/CHS/JPT/KHV, autres populations 1000G pertinentes | tester la logique de sélection sur un socle public, reproductible et immédiatement disponible |
| **Validation B — 1000G + EGA prioritaires** | MGUA Malagasy WGS, MAGE Madagascar SNP, GenomeAsia, Angola/Mozambique WGS si accès obtenu | tester l’apport des références malgaches, asiatiques et africaines proches de l’océan Indien |
| **Validation C — EGA complémentaires** | AGVP, H3Africa WGS, Pacific WGS selon accès, QC et intersection SNP | évaluer la stabilité de l’ancrage africain large et de l’axe austronésien exploratoire |
| **Validation D — Simulation réunionnaise** | simulation 4 à 6 composantes inspirées des pools retenus | tester la compression proche de 14 %, la non-homogénéité géographique et les profils minoritaires/fondateurs |

Les groupes 1000G ACB/ASW, GIH/BEB et les simulations tri- ou multi-ancestrales restent utiles, mais ils ne doivent plus être les seuls supports de validation. L’objectif est de comparer la stratégie géo-ancestrale dans plusieurs contextes : références publiques seules, références EGA enrichies, puis simulation contrôlée de type réunionnais.
...
- une simulation multi-composantes inspirée des panels témoins retenus, avec distribution non homogène des profils d’ascendance par secteur.
...
Lorsque les données EGA WGS sont accessibles, la validation puce → WGS devra être répétée séparément sur les panels compatibles : 1000G high-coverage, MGUA Malagasy WGS, GenomeAsia, Angola/Mozambique, H3Africa/AGVP et Pacific WGS si le nombre de SNP communs est suffisant. Les datasets SNP-only, comme MAGE Madagascar, seront utilisés pour tester la stabilité PCA/ADMIXTURE, mais pas pour mesurer la couverture WGS.
...
3. `reference_panel_inventory.tsv` ;
4. `reference_panel_access_status.tsv` ;
5. `reference_panel_QC_report` ;
6. `reference_panel_intersection_SNP_report` ;
7. `reference_panel_batch_effect_report` ;
8. `PCA_global_2500` ;
9. `PCA_reference_sensitivity_report` ;
10. `ADMIXTURE_global_2500` ;
11. `ADMIXTURE_reference_sensitivity_report` ;
12. `geoancestry_cells_reference_anchoring_report` ;
13. `ROH_report_2500` ;
14. `IBD_report_geoancestral` ;
15. `phase_report_population_familles` ;
16. `selection_stricte_350` ;
17. `selection_hybride_350` ;
18. `selection_consensus` si multi-seed/multi-ordre ;
19. `rapport_bras_decouverte` ;
20. `rapport_recalibrage_frequences` ;
21. `rapport_imputation` ;
22. `rapport_LAI` si réalisé ;
23. `audit_versions_parametres`.
...
| Accès EGA incomplet ou retardé | datasets en accès contrôlé, délais DAC | phase 0 dédiée, socle 1000G public comme solution de repli, analyses par niveaux |
| Batch effect entre panels témoins | technologies, builds, couvertures et pipelines différents | harmonisation stricte, intersection SNP, PCA de sensibilité, rapport batch effect |
| Surinterprétation des panels témoins | confusion entre référence génétique et identité individuelle | garde-fous de langage, labels prudents, comparaison multi-panels et multi-K |
...
### Phase 0 — Accès et harmonisation des panels témoins, 4 à 12 semaines en parallèle

| Semaine | Tâche | Livrable |
|---|---|---|
| 1 | Inventaire 1000G / EGA, priorisation des panels | `reference_panel_inventory.tsv` |
| 1–2 | Demandes d’accès DAC/EGA pour MGUA, MAGE, GenomeAsia, Angola/Mozambique, AGVP, H3Africa, Pacific WGS | `reference_panel_access_status.tsv` |
| 2–6 | Téléchargement des ressources disponibles et contrôle des formats | dossiers de données versionnés |
| 3–8 | Harmonisation build/strand, intersection SNP avec la puce 1,9 M, retrait SNP ambigus | `reference_panel_intersection_SNP_report` |
| 6–12 | PCA de sensibilité et contrôle batch effect | `reference_panel_QC_report` + `reference_panel_batch_effect_report` |

La phase 0 ne doit pas bloquer le démarrage des analyses avec 1000G high-coverage. Les panels EGA seront intégrés progressivement, selon les accès obtenus et la qualité observée.

### Phase 1 — Validation externe et simulation, 8 à 10 semaines

| Semaine | Tâche | Livrable |
|---|---|---|
| 1 | Préparation 1000G high-coverage et panels EGA disponibles | datasets QC + inventaire panels |
| 2 | Simulation tri-ancestrale | dataset simulé |
| 3 | Simulation puce 1,9 M depuis WGS 1000G/EGA compatibles | jeu dégradé puce |
...
| 9–10 | Synthèse et recommandations | paramètres V3.5 finalisés |
...
| 3 | PCA-0/PCA-1/PCA-2 + ADMIXTURE-0/1/2/3 selon panels disponibles | structure géo-ancestrale initiale |
...
6. **Panels témoins retenus** : accès obtenu, QC validé, intersection SNP suffisante, absence de batch effect majeur et justification des panels exclus.
7. **Cellules géo-ancestrales** : seuils minimaux, règles de protection des profils rares et documentation des cellules non représentées.
8. **Poids S_div** : poids initiaux ou poids recalibrés après validation.
9. **Procédure de récupération** : règles activées et rapport de substitution produit.
10. **Fréquences finales** : format de reporting brut / pondéré / imputé.
11. **Gouvernance familiale** : protocole de gestion des apparentements inattendus et erreurs mendéliennes.
...
La bibliographie est organisée en 18 sous-sections thématiques alignées sur la structure du protocole, afin de faciliter la traçabilité entre chaque choix méthodologique et sa source. Chaque sous-section indique brièvement la ou les sections du document qu'elle soutient.
...
Soutient l'interprétation des composantes ancestrales attendues à La Réunion et la définition des pools témoins (§ 6.2 à § 6.5).
...
Soutient le choix des références ancestrales utilisées en projection PCA et ADMIXTURE supervisée (§ 6.2 à § 6.5).
...
Soutient la distinction explicite faite par le protocole entre « ascendance génétique inférée » et « ethnicité sociale » (§ 1.2, § 6.1, § 6.6). Indispensable pour la défense devant un comité de protection des personnes.
...
### 21.18 Datasets opérationnels EGA + 1000 Genomes pour les pools témoins

Soutient les sections § 6.2 à § 6.8, § 13.2, § 13.6 et § 19.4–19.5. Ces références correspondent aux datasets concrets qui pourront être utilisés comme pools témoins pour la PCA projetée, ADMIXTURE avec références, la validation géo-ancestrale, l’imputation ou la LAI.

Ces datasets ne sont pas utilisés comme substituts à la cohorte réunionnaise. Ils servent à ancrer les axes PCA, stabiliser l’interprétation des composantes ADMIXTURE, tester la robustesse des profils d’ascendance génétique inférée et soutenir, lorsque pertinent, l’imputation ou la LAI. Leur utilisation sera conditionnée à l’accès DAC/EGA, au passage du QC commun, à l’intersection suffisante avec la puce SNP 1,9 M, à l’absence de batch effect majeur et à une interprétation prudente des composantes.

- Byrska-Bishop M, Evani US, Zhao X, et al. High-coverage whole-genome sequencing of the expanded 1000 Genomes Project cohort including 602 trios. *Cell*, 2022;185(18):3426-3440.e19. DOI: 10.1016/j.cell.2022.08.004. Ressource 1000 Genomes high-coverage / IGSR : socle public multi-ancestral, 3 202 WGS à 30×, incluant 602 trios, utile pour PCA, ADMIXTURE, phasage et imputation.
- Hamid I, Raveloson SNS, Spiral GJ, Ravelonjanahary S, Raharivololona BM, Randria JM, Zafimaro M, Randriambola TA, Andriantsoa RM, Andriamahefa TJ, Rafidison BFL, Mughal M, Emde AK, Hendershott M, LeBaron von Baeyer S, Wasik KA, Ranaivoarisoa JF, Yerges-Armstrong L, Castel SE, Rakotoarivony R. Mid-pass Whole-genome Sequencing in a Malagasy Cohort Uncovers Body Composition Associations. *HGG Advances*, 2024;5:100343. DOI: 10.1016/j.xhgg.2024.100343. Dataset EGA : `EGAS50000000496` / `EGAD50000000708`. Ressource prioritaire pour l’ancrage malgache : 264 individus malgaches en WGS mid-pass, issus de trois régions de Madagascar.
- Pierron D, Heiske M, Razafindrazaka H, et al. Genomic landscape of human diversity across Madagascar. *Proceedings of the National Academy of Sciences*, 2017;114(32):E6498-E6506. DOI: 10.1073/pnas.1704906114. Dataset EGA : `EGAS00001002549` / `EGAD00010001612`. Ressource complémentaire pour la structure interne malgache : génotypages Omni 2.5M issus d’un échantillonnage dense à Madagascar.
- Pierron D, Heiske M, Razafindrazaka H, et al. Strong selection during the last millennium for African ancestry in the admixed population of Madagascar. *Nature Communications*, 2018;9:932. DOI: 10.1038/s41467-018-03342-5. Ressource utile pour l’interprétation LAI et la dynamique africaine/austronésienne à Madagascar.
- GenomeAsia100K Consortium. The GenomeAsia 100K Project enables genetic discoveries across Asia. *Nature*, 2019;576:106-111. DOI: 10.1038/s41586-019-1793-z. Dataset EGA : `EGAS00001002921` / `EGAD00001005975`. Ressource prioritaire pour les composantes sud-asiatiques, est-asiatiques et sud-est asiatiques.
- Tallman S, Sungo MDD, Saranga S, Beleza S, et al. Whole genomes from Angola and Mozambique inform about the origins and dispersals of major African migrations. *Nature Communications*, 2023;14:7967. Dataset EGA : `EGAS00001007458` / `EGAD00001011992`. Ressource prioritaire pour les composantes bantoues, l’Afrique australe-orientale et les trajectoires historiques liées à l’océan Indien.
- Gurdasani D, Carstensen T, Tekola-Ayele F, et al. The African Genome Variation Project shapes medical genetics in Africa. *Nature*, 2015;517:327-332. DOI: 10.1038/nature13997. Dataset EGA : `EGAS00001000960` / `EGAD00001001663`. Ressource complémentaire africaine : génotypages denses et WGS africains incluant notamment Baganda, Zulu et groupes d’Éthiopie.
- Choudhury A, Aron S, Botigué LR, et al. High-depth African genomes inform human migration and health. *Nature*, 2020;586:741-748. DOI: 10.1038/s41586-020-2859-7. Dataset EGA : `EGAS00001005972` / `EGAD00001008577`. Ressource complémentaire africaine : joint VCF de 410 WGS africains, incluant génomes haute et moyenne couverture.
- Choin J, Mendoza-Revilla J, Arauna LR, et al. Genomic insights into population history and biological adaptation in Oceania. *Nature*, 2021;592:583-589. DOI: 10.1038/s41586-021-03236-5. Dataset EGA : `EGAS00001004540` / `EGAD00001006880`. Ressource exploratoire pour l’axe austronésien : 317 génomes haute couverture issus de populations du Pacifique.
...
| **V3.5 panels témoins EGA + 1000G** | Intégration opérationnelle des références externes | Ajout d’un catalogue hiérarchisé des panels témoins 1000G/IGSR et EGA ; analyse PCA/ADMIXTURE par niveaux ; critères d’inclusion/exclusion des panels ; phase 0 d’accès et d’harmonisation ; sorties QC spécifiques aux références ; ajout des références bibliographiques opérationnelles en § 21.18 |
...
- intégration contrôlée des panels témoins 1000G/IGSR et EGA pour ancrer PCA/ADMIXTURE sans remplacer la cohorte réunionnaise ;
- auditabilité des scores, paramètres, seuils, panels retenus, panels exclus et substitutions.
